...
@interface ZWUserHistoryListVC ()<UITableViewDelegate,UITableViewDataSource,MoviesDetailsVCDelegate,NLSliderSwitchProtocol>
...
@implementation ZWUserHistoryListVC
