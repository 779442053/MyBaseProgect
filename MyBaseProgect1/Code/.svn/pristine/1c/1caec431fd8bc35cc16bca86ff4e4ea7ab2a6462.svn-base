 ...
 *  @param segmentHead MLMSegmentHead
 */
@optional
- (void) didSelectedIndex:(MLMSegmentHead *)segmentHead andIndex:(NSInteger)index;
 ...
 *  block
 */
@property (nonatomic, copy) void(^selectedIndex2)(MLMSegmentHead*,NSInteger);
