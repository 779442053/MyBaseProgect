...
#import "MBProgressHUD+ZWMyHud.h"
#import "AppDelegate+ZWWAppDelegate.h"
const NSInteger hideTime = 2;
@implementation MBProgressHUD (ZWMyHud)
...
//
//    }else{
//        label.height = [msg heightForFont:label.font width:label.viewwidth] + 2 * padding;
//        label.bottom = (kiOS7Later  ? 64.0 : 0.0);
//        [[kAppDelegate getCurrentUIVC].view addSubview:label];
//
//        [UIView animateWithDuration:0.3 animations:^{
//            label.top = (kiOS7Later ? 64.0 : 0.0);
//        } completion:^(BOOL finished) {
//            [UIView animateWithDuration:0.2 delay:2 options:UIViewAnimationOptionCurveEaseInOut animations:^{
//                label.bottom = (kiOS7Later ? 64.0 : 0.0);
//            } completion:^(BOOL finished) {
