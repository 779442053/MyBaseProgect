...
#import "ZWAlterView.h"
#import "UIView+ZWFram.h"

@interface ZWAlterView ()<UITextViewDelegate>
...
- (void)setUpUI{
    ...
    self.contentView.frame = CGRectMake((KScreenWidth - 285) / 2, (KScreenWidth - 215) / 2, 285, 215);
    ...
    // 标题
    UILabel *titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 10, self.contentView.viewwidth, 22)];
    ...
    // 填写异常情况描述的textView
    self.textView = [[UITextView alloc]initWithFrame:CGRectMake(22, titleLabel.maxY + 10, self.contentView.viewwidth - 44, 103)];
    ...
    // textView里面的占位label
    self.messageLabel = [[UILabel alloc]initWithFrame:CGRectMake(8, 8, self.textView.viewwidth - 16, self.textView.viewheight - 16)];
    ...
    // 红色提示label
    UILabel *redLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.textView.x, self.textView.maxY + 5, self.textView.viewwidth, 20)];
